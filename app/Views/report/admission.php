    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Admission Patients</h1> <!-- Replace this with a fixed title -->
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= base_url() ?>dashboard">Home</a></li>
                    <li class="breadcrumb-item"><a href="<?= base_url() ?>report">Report</a></li>
                    <li class="breadcrumb-item active">Admission Patients</li> <!-- Fixed breadcrumb title -->
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow-sm">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="card-title mb-0 ">Admission Patients</h4> <!-- Title updated -->
    ...
    <tbody>
        <?php foreach ($AdmissionData as $patient): ?>
            <tr>
...
document.addEventListener('DOMContentLoaded', function () {
    const patients = <?= json_encode($AdmissionData) ?>;
