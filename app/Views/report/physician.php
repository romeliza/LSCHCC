                ...
                <div class="col-lg-12">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body pt-3 small-font">
                            ...
                            <div id="physician-table" class="table-responsive mt-4"></div> <!-- Container for Grid.js -->
                        </div>
                    </div>
                </div>
            </div>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    // Parse physician data from PHP
    const rowData = <?= json_encode($physicianData) ?>; // Replace with $physicianData from your controller
    ...
    // Map data into Grid.js format with Middle Name between First and Last Name
    let gridData = rowData.map(physician => [
        physician.Lastname + ', ' + physician.Firstname + (physician.Middlename ? ' ' + physician.Middlename : ''),
    ...
    function initializeGrid(data, limit) {
        return new gridjs.Grid({
            columns: ['Physician Name', 'Contact Number', 'Specialization', 'Email', 'Date Added'],
            data: data,
            sort: true,
            search: true,
        ...
        }).render(document.getElementById('physician-table'));
    }
    ...
    function filterData() {
        ...
        const filteredData = rowData.filter(physician => {
            const createdAt = new Date(physician.created_at);
    ...
    function printTable() {
        ...
        printContent += '<h1>List of Physicians</h1><table><thead><tr>';
        printContent += '<th>Physician Name</th><th>Contact Number</th><th>Specialization</th><th>Email</th><th>Date Added</th></tr></thead><tbody>';
