                ...
                <div class="col-lg-12">
                    <div class="card shadow-sm">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title mb-0 small-font">List of Patients</h4>
                        ...
                        <div class="card-body pt-3 small-font">
                            ...
                            <div id="patient-table" class="table-responsive mt-4"></div> <!-- Container for Grid.js -->
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    // Parse patient data from PHP
    const rowData = <?= json_encode($patients) ?>; // Replace with $patients from your controller
    ...
    // Map data into Grid.js format (Exclude "Updated At" and include new fields)
    let gridData = rowData.map(patient => [
        patient.Lastname + ', ' + patient.Firstname,
        patient.Occupation,
        patient.Sex,
        patient.ContactNumber,
      
        patient.region,          // Add Region
        patient.province,        // Add Province
        patient.municipality,    // Add Municipality
        patient.barangay,        // Add Barangay
    ...
    function initializeGrid(data, limit) {
        return new gridjs.Grid({
            columns: ['Patient Name', 'Occupation', 'Sex', 'Contact Number', 'Region', 'Province', 'Municipality', 'Barangay', 'Date Added'],
            data: data,
            sort: true,
            search: true,
        ...
        }).render(document.getElementById('patient-table'));
    }
    ...
    function filterData() {
        ...
        const filteredData = rowData.filter(patient => {
    ...
    function printTable() {
        ...
        printContent += '<h1>List of Patients</h1><table><thead><tr>';
